...
var INGREDIENTS = [
  ...
  ,
  {
    ...
    "cat": "크리닉",
    "mid": "pH조절",
    "role": "pH 조절 / 큐티클 수렴 / 칼슘 제거",
    "strength": "약",
    "feature": "pH 조절, 킬레이트",
    "desc": "감귤류 유래 유기산으로 시술 후 높아진 pH를 낮춰 큐티클을 수렴시킨다. 미네랄 침착을 제거하는 킬레이트 역할도 하며 모발 윤기를 높인다.",
    "source": "system"
  },
  {
    "ko": "아세트산",
    ...
    "cat": "크리닉",
    "mid": "pH조절",
    "role": "약산성 pH 유지 / 큐티클 정돈",
    "strength": "약",
    "feature": "pH 조절, 큐티클 닫기",
    "desc": "식초의 주성분으로 약산성 환경을 만들어 열린 큐티클을 닫아준다. 시술 후 모발 표면을 매끄럽게 정돈하고 잔류 알칼리를 중화한다.",
    "source": "system"
  },
  {
    "ko": "타르타르산",
    ...
    "strength": "약",
    "feature": "pH 완충, 수렴",
    "desc": "포도에서 유래한 유기산으로 제품 pH를 안정적으로 유지하는 완충 역할을 한다. 시술 후 큐티클 수렴에 보조적으로 사용된다.",
    "source": "system"
  },
  {
    "ko": "아미노메틸프로판올",
    "en": "Aminomethyl Propanol",
    "cat": "세정",
    "mid": "pH조절",
    "role": "제품 pH 상승 / 제형 안정",
    "strength": "약",
    "feature": "pH 조절, 알칼리",
    "desc": "유기 아민 계열 pH 조절제로 카보머 등 겔화제를 중화시켜 제형을 안정적으로 만든다. 자극이 적어 다양한 제품에 사용된다.",
    "source": "system"
  },
  {
    "ko": "트라이에탄올아민",
    ...
    "strength": "약",
    "feature": "pH 조절, 유화",
    "desc": "유기 아민 계열로 산성 성분을 중화하고 유화를 안정시킨다. 과량 사용 시 자극이 있을 수 있어 적정 농도 유지가 중요하다.",
    "source": "system"
  },
  {
    "ko": "아모디메티콘",
    ...
    "cat": "크리닉",
    "mid": "코팅",
    "role": "손상 부위 선택적 코팅 / 경량 실리콘",
    "strength": "중",
    "feature": "선택적 코팅, 경량 실리콘",
    "desc": "아미노기가 달린 실리콘으로 손상된 부위에 선택적으로 달라붙어 코팅한다. 건강한 부위에는 쌓이지 않아 다이메티콘보다 가볍고 자연스러운 마무리감을 준다.",
    "source": "system"
  },
  {
    "ko": "다이메티코놀",
    ...
    "strength": "강",
    "feature": "고광택, 열 차단",
    "desc": "다이메티콘의 변형으로 모발에 고광택 피막을 형성한다. 열에 안정적이어서 고데기 사용 전 열 보호 역할을 하며 습기 차단에도 효과적이다.",
    "source": "system"
  },
  {
    "ko": "페닐 트라이메티콘",
    ...
    "strength": "중",
    "feature": "고광택, 부드러움",
    "desc": "굴절률이 높은 실리콘으로 모발에 유리처럼 반짝이는 광택을 준다. 오일 세럼에 많이 사용되며 끈적임 없이 매끄러운 질감을 만든다.",
    "source": "system"
  },
  {
    "ko": "사이클로펜타실록산",
    ...
    "strength": "약",
    "feature": "휘발성 실리콘, 경량감",
    "desc": "D5 실리콘으로 불리며 발림성을 개선하고 모발에 가벼운 코팅을 남긴다. 빠르게 휘발되어 끈적임이 없고 다른 실리콘의 캐리어 역할을 한다.",
    "source": "system"
  },
  {
    "ko": "비스아미노프로필 다이메티콘",
    ...
    "cat": "크리닉",
    "mid": "코팅",
    "role": "손상 모발 집중 코팅 / 큐티클 매꿈",
    "strength": "중",
    "feature": "손상 집중 코팅, 빗질 용이",
    "desc": "양이온성 실리콘으로 손상된 모발 표면의 음전하 부위에 강하게 결합한다. 끊어지기 쉬운 모발의 빗질을 쉽게 만들고 큐티클 사이를 매꿔준다.",
    "source": "system"
  },
  {
    "ko": "세테아릴 알코올",
    ...
    "strength": "약",
    "feature": "유화제, 유연제",
    "desc": "세틸 알코올과 스테아릴 알코올의 혼합물로 크림 제형을 안정시키고 모발에 부드러운 감촉을 준다. 컨디셔너와 트리트먼트의 베이스 성분이다.",
    "source": "system"
  },
  {
    "ko": "이소프로필 미리스테이트",
    "en": "Isopropyl Myristate",
    "cat": "크리닉",
    "mid": "유화",
    "role": "제품 퍼짐성 개선 / 가벼운 유분감",
    "strength": "약",
    "feature": "퍼짐성, 경량 유분",
    "desc": "가벼운 에스터 오일로 제품이 모발에 잘 펴지도록 돕고 끈적임 없는 유분감을 준다. 헤어 오일과 세럼에 많이 사용된다.",
    "source": "system"
  },
  {
    "ko": "이소프로필 팔미테이트",
    "en": "Isopropyl Palmitate",
    "cat": "크리닉",
    "mid": "유화",
    "role": "모발 윤활 / 매끄러운 도포감",
    "strength": "약",
    "feature": "윤활, 도포감",
    "desc": "가벼운 에스터 오일로 모발 표면을 매끄럽게 만들고 제품이 골고루 도포되도록 돕는다. 실리콘 프리 제품에서 윤활제 역할로 사용된다.",
    "source": "system"
  },
  {
    "ko": "프로필렌 글라이콜",
    ...
    "strength": "약",
    "feature": "보습, 용제",
    "desc": "글리세린보다 가벼운 보습제로 공기 중 수분을 끌어당기고 다른 성분을 녹이는 용제 역할도 한다. 염모제와 펌제에서도 성분 침투를 돕는다.",
    "source": "system"
  },
  {
    "ko": "뷰틸렌 글라이콜",
    ...
    "cat": "크리닉",
    "mid": "보습",
    "role": "보습 / 성분 용해 및 침투 보조",
    "strength": "약",
    "feature": "보습, 침투 보조",
    "desc": "가벼운 보습제이자 용제로 다른 활성 성분이 모발에 잘 흡수되도록 돕는다. 끈적임이 적어 다양한 제형에 활용된다.",
    "source": "system"
  },
  {
    "ko": "헥실렌 글라이콜",
    ...
    "strength": "약",
    "feature": "용제, 제형 안정",
    "desc": "다양한 성분을 균일하게 녹이는 용제로 제형이 분리되지 않도록 안정시킨다. 보습 효과도 일부 있어 세정 제품에 많이 사용된다.",
    "source": "system"
  },
  {
    "ko": "소르비톨",
    ...
    "strength": "약",
    "feature": "보습, 점도 조절",
    "desc": "당알코올 계열 보습제로 글리세린과 유사하게 수분을 잡아두는 역할을 한다. 제품 질감을 부드럽게 만들어주기도 한다.",
    "source": "system"
  },
  {
    "ko": "자일리톨",
    ...
    "strength": "약",
    "feature": "보습, 두피 밸런스",
    "desc": "당알코올 계열로 두피에 수분을 유지시키고 두피 표면의 미생물 균형을 잡아주는 데 도움을 준다.",
    "source": "system"
  },
  {
    "ko": "폴리쿼터늄-7",
    ...
    "strength": "약",
    "feature": "코팅, 정전기 억제",
    "desc": "양이온 폴리머로 모발에 얇은 코팅막을 형성해 정전기를 억제하고 부드러운 감촉을 준다. 샴푸와 컨디셔너에 모두 사용된다.",
    "source": "system"
  },
  {
    "ko": "폴리쿼터늄-6",
    ...
    "strength": "약",
    "feature": "컨디셔닝, 보호막",
    "desc": "양이온 폴리머로 세정 중에도 모발에 보호막을 남겨 빗질을 쉽게 만든다. 가벼워서 가는 모발에도 부담 없이 사용할 수 있다.",
    "source": "system"
  },
  {
    "ko": "폴리쿼터늄-37",
    ...
    "strength": "중",
    "feature": "홀드, 볼륨",
    "desc": "스타일링 제품에 사용되는 폴리머로 모발에 자연스러운 홀드와 볼륨을 준다. 끈적임이 적고 부드러운 느낌을 유지한다.",
    "source": "system"
  },
  {
    "ko": "VP/VA 코폴리머",
    ...
    "role": "스타일 고정 / 습기 차단",
    "strength": "중",
    "feature": "스타일 고정, 습기 차단",
    "desc": "헤어스프레이와 무스의 핵심 폴리머로 모발 스타일을 고정하고 습기를 차단해 볼리는 것을 방지한다. 브러싱으로 쉽게 제거된다.",
    "source": "system"
  },
  {
    "ko": "PVP",
    ...
    "strength": "중",
    "feature": "고정력, 피막",
    "desc": "스타일링 제품의 고정력을 만드는 합성 폴리머다. 모발 표면에 투명한 피막을 만들어 스타일을 유지하고 윤기를 더해준다.",
    "source": "system"
  },
  {
    "ko": "밀랍",
    ...
    "role": "모발 정돈 / 자연스러운 홀드",
    "strength": "중",
    "feature": "홀드, 자연스러운 마무리",
    "desc": "천연 왁스로 모발을 정돈하고 자연스러운 홀드를 준다. 수분 증발을 막는 역할도 하며 건조한 모발 끝을 코팅해 갈라짐을 방지한다.",
    "source": "system"
  },
  {
    "ko": "카나우바 왁스",
    "en": "Copernicia Cerifera Wax",
    "cat": "크리닉",
    "mid": "왁스",
    "role": "강한 홀드 / 광택",
    "strength": "중",
    "feature": "강한 홀드, 광택",
    "desc": "브라질산 야자에서 추출한 식물 왁스로 높은 녹는점과 강한 홀드가 특징이다. 포마드와 왁스 제품에 많이 사용되며 자연스러운 광택을 낸다.",
    "source": "system"
  },
  {
    "ko": "마이크로크리스탈린 왁스",
    ...
    "strength": "약",
    "feature": "제형 안정, 질감",
    "desc": "석유 유래 왁스로 헤어 왁스와 스타일링 제품에 부드러운 질감을 부여하고 제형을 안정시킨다.",
    "source": "system"
  },
  {
    "ko": "캔델릴라 왁스",
    "en": "Euphorbia Cerifera Wax",
    "cat": "크리닉",
    "mid": "왁스",
    "role": "가벼운 홀드 / 윤기",
    "strength": "약",
    "feature": "경량 홀드, 윤기",
    "desc": "멕시코산 캔델릴라 식물에서 추출한 왁스로 밀랍보다 가볍고 깨끗한 질감을 준다. 비건 제품에서 밀랍 대체로 많이 사용된다.",
    "source": "system"
  },
  {
    "ko": "PEG-40 하이드로제네이티드 캐스터 오일",
    "en": "PEG-40 Hydrogenated Castor Oil",
    "cat": "크리닉",
    "mid": "유화",
    "role": "오일 가용화 / 에센셜 오일 분산",
    "strength": "약",
    "feature": "가용화, 분산",
    "desc": "물에 녹지 않는 오일이나 향을 물 기반 제품에 균일하게 분산시키는 가용화제다. 헤어 미스트와 토닉에 많이 사용된다.",
    "source": "system"
  },
  {
    "ko": "세테아레스-20",
    ...
    "strength": "약",
    "feature": "유화, 제형 안정",
    "desc": "비이온 유화제로 오일과 물을 안정적으로 섞어 크림 질감의 제형을 만든다. 트리트먼트와 헤어팩의 기본 유화제로 사용된다.",
    "source": "system"
  },
  {
    "ko": "소르비탄 올리에이트",
    ...
    "strength": "약",
    "feature": "유화 보조, 분산",
    "desc": "비이온 유화제로 오일 성분을 물 기반 제형에 안정적으로 분산시킨다. 다른 유화제와 함께 사용하면 유화 안정성이 높아진다.",
    "source": "system"
  },
  {
    "ko": "폴리소르베이트 20",
    ...
    "strength": "약",
    "feature": "가용화, 분산",
    "desc": "가벼운 가용화제로 향료나 에센셜 오일을 수성 제품에 균일하게 분산시킨다. 두피 토닉과 미스트에 사용된다.",
    "source": "system"
  },
  {
    "ko": "폴리소르베이트 80",
    ...
    "strength": "약",
    "feature": "유화, 가용화",
    "desc": "비이온 유화제이자 가용화제로 오일 성분을 물 기반 제품에 균일하게 섞어준다. 약산성 샴푸와 세정 제품에 많이 사용된다.",
    "source": "system"
  },
  {
    "ko": "잔탄검",
    ...
    "strength": "약",
    "feature": "점도 조절, 현탁",
    "desc": "천연 다당류로 제품의 점도를 높이고 입자가 가라앉지 않게 현탁 상태를 유지시킨다. 천연 제품에서 카보머 대체로 많이 사용된다.",
    "source": "system"
  },
  {
    "ko": "셀룰로오스검",
    ...
    "strength": "약",
    "feature": "점도 조절, 안정",
    "desc": "식물 셀룰로오스 유래 점도 조절제로 제품을 균일하고 안정적으로 만든다. 투명한 겔부터 크림까지 다양한 질감을 만들 수 있다.",
    "source": "system"
  },
  {
    "ko": "구아검",
    ...
    "strength": "약",
    "feature": "컨디셔닝, 질감",
    "desc": "구아콩에서 추출한 천연 다당류로 컨디셔너에 매끄러운 슬립감을 준다. 모발이 엉키지 않게 돕고 자연스러운 질감을 만든다.",
    "source": "system"
  },
  {
    "ko": "하이드록시프로필 메틸셀룰로오스",
    "en": "Hydroxypropyl Methylcellulose",
    "cat": "세정",
    "mid": "점도조절",
    "role": "제형 안정 / 피막 형성",
    "strength": "약",
    "feature": "점도 조절, 피막",
    "desc": "셀룰로오스 유래 다기능 성분으로 점도를 조절하고 모발에 가벼운 피막을 형성한다. 스타일링 겔에서도 사용된다.",
    "source": "system"
  },
  {
    "ko": "카프릴릴 글라이콜",
    ...
    "strength": "약",
    "feature": "방부 보조, 보습",
    "desc": "보습 효과와 항균 효과를 동시에 가진 성분으로 페녹시에탄올과 함께 사용하면 보존력이 크게 높아진다. 파라벤 프리 제품에서 많이 활용된다.",
    "source": "system"
  },
  {
    "ko": "벤질 알코올",
    ...
    "strength": "약",
    "feature": "방부, 용제",
    "desc": "천연에서도 발견되는 방향족 알코올로 방부 효과와 용제 역할을 겸한다. 향의 고정 역할도 하며 다른 보존제와 함께 사용된다.",
    "source": "system"
  },
  {
    "ko": "다이하이드로아세트산",
    ...
    "strength": "약",
    "feature": "항균, 보존",
    "desc": "곰팡이와 세균 모두에 효과적인 보존제로 넓은 pH 범위에서 작용한다. 벤질 알코올과 함께 쓰이는 경우가 많다.",
    "source": "system"
  },
  {
    "ko": "메틸파라벤",
    ...
    "cat": "세정",
    "mid": "보존제",
    "role": "곰팡이·세균 억제 / 제품 보존",
    "strength": "중",
    "feature": "광범위 방부",
    "desc": "파라벤 계열 방부제로 넓은 범위의 미생물을 억제한다. 오랫동안 사용되어온 성분이나 파라벤 프리 트렌드로 대체가 진행 중이다.",
    "source": "system"
  },
  {
    "ko": "프로필파라벤",
    ...
    "strength": "중",
    "feature": "곰팡이 억제, 보존",
    "desc": "메틸파라벤과 함께 사용되어 보존력을 높이는 파라벤 계열 성분이다. 특히 곰팡이 억제에 효과적이다.",
    "source": "system"
  },
  {
    "ko": "이미다졸리디닐 우레아",
    ...
    "strength": "중",
    "feature": "세균 억제, 보존",
    "desc": "포름알데히드 방출형 방부제로 세균 억제력이 높다. 파라벤과 함께 사용되는 경우가 많으나 민감한 피부에는 자극을 줄 수 있다.",
    "source": "system"
  },
  {
    "ko": "DMDM 하이단토인",
    ...
    "strength": "중",
    "feature": "항균, 보존",
    "desc": "포름알데히드 방출형 방부제로 세균과 곰팡이를 억제한다. 논란이 있어 최근에는 대체 보존제로 전환하는 추세다.",
    "source": "system"
  },
  {
    "ko": "올레일 알코올",
    ...
    "strength": "약",
    "feature": "유연제, 질감",
    "desc": "불포화 지방 알코올로 모발에 유연한 감촉을 주고 제품에 크리미한 질감을 만든다. 세틸 알코올보다 가벼운 편이다.",
    "source": "system"
  },
  {
    "ko": "마그네슘 설페이트",
    ...
    "strength": "약",
    "feature": "매트 질감, 볼륨",
    "desc": "엡솜 솔트로도 알려진 성분으로 씨솔트 스프레이에 사용되어 모발에 매트한 질감과 볼륨을 준다. 비치웨이브 스타일링에 효과적이다.",
    "source": "system"
  },
  {
    "ko": "소듐 설페이트",
    ...
    "strength": "약",
    "feature": "충전, 농도 조절",
    "desc": "무기염으로 제품의 농도와 점도를 조절하는 충전제 역할을 한다. 세정력에는 기여하지 않으며 제형을 안정적으로 만드는 데 사용된다.",
    "source": "system"
  },
  {
    "ko": "칼슘 하이드록사이드",
    ...
    "strength": "강",
    "feature": "강알칼리, 릴렉서",
    "desc": "수산화칼슘으로 노라이(no-lye) 릴렉서의 활성 성분이다. 구아니딘 카보네이트와 혼합하여 곱슬모를 펴는 데 사용된다. 강한 알칼리이므로 두피 보호가 필수다.",
    "source": "system"
  },
  {
    "ko": "수산화나트륨",
    ...
    "strength": "강",
    "feature": "강알칼리, 직모 변환",
    "desc": "가성소다로 릴렉서(직모 시술)에 사용되는 강한 알칼리 성분이다. 모발 결합을 영구적으로 변형시키며 자극이 매우 강하므로 전문가 전용이다.",
    "source": "system"
  },
  {
    "ko": "치오글리콜산",
    ...
    "strength": "강",
    "feature": "결합 분해, 산성 환원",
    "desc": "산성 펌에서 사용되는 환원제로 시스틴 결합을 풀어 모발 형태를 변형시킨다. 암모늄 치오글리콜레이트와 달리 산성 pH에서 작용하여 손상이 비교적 적다.",
    "source": "system"
  },
  {
    "ko": "시스테인",
    ...
    "cat": "펌제",
    "mid": "환원제",
    "role": "저자극 환원 / 코스메틱 스트레이트",
    "strength": "약",
    "feature": "저자극, 부드러운 환원",
    "desc": "아미노산 유래 환원제로 모발 결합을 부드럽게 풀어 자연스러운 웨이브나 스트레이트를 만든다. 시스테아민보다 더 순한 편으로 손상이 적다.",
    "source": "system"
  },
  {
    "ko": "디치오디글리콜산",
    ...
    "cat": "펌제",
    "mid": "환원제",
    "role": "결합 분해 보조 / 시술 시간 단축",
    "strength": "중",
    "feature": "환원 보조, 속도 향상",
    "desc": "치오글리콜산의 이량체로 환원제의 작용 속도를 높여 시술 시간을 단축한다. 주 환원제와 병용하여 사용된다.",
    "source": "system"
  },
  {
    "ko": "소듐 치오글리콜레이트",
    "en": "Sodium Thioglycolate",
    "cat": "펌제",
    "mid": "환원제",
    "role": "산성~중성 펌 환원 / 제모제",
    "strength": "중",
    "feature": "환원, 제모",
    "desc": "치오글리콜산의 나트륨 염으로 산성~중성 펌에서 환원제로 사용된다. 제모 크림의 활성 성분이기도 하다.",
    "source": "system"
  },
  {
    "ko": "포름알데히드",
    ...
    "cat": "크리닉",
    "mid": "결합제",
    "role": "케라틴 트리트먼트 결합 / 직모 코팅",
    "strength": "강",
    "feature": "결합, 직모화",
    "desc": "브라질리언 블로우아웃 등 케라틴 트리트먼트에서 모발 단백질을 교차결합시켜 매끄럽게 만드는 성분이다. 건강 우려로 많은 국가에서 사용이 규제되고 있다.",
    "source": "system"
  },
  {
    "ko": "글라이옥실산",
    ...
    "cat": "크리닉",
    "mid": "결합제",
    "role": "포름알데히드 프리 케라틴 트리트먼트",
    "strength": "중",
    "feature": "결합, 직모화",
    "desc": "포름알데히드를 대체하는 케라틴 트리트먼트 성분으로 모발 단백질과 결합해 곱슬기를 줄이고 매끄럽게 만든다. 열 활성화 방식으로 작용한다.",
    "source": "system"
  },
  {
    "ko": "폴리에틸렌 글라이콜",
    ...
    "strength": "약",
    "feature": "보습, 용제",
    "desc": "분자량에 따라 보습제, 용제, 피막 형성제 등 다양한 역할을 하는 다기능 성분이다. 모발에 부드러운 감촉을 주고 다른 성분의 침투를 돕는다.",
    "source": "system"
  },
  {
    "ko": "미네랄 오일",
    ...
    "strength": "약",
    "feature": "코팅, 수분 차단",
    "desc": "정제된 석유 유래 오일로 모발 표면에 코팅막을 형성해 수분이 빠져나가는 것을 막는다. 가볍고 저렴해 많은 제품에 사용되지만 무거울 수 있다.",
    "source": "system"
  },
  {
    "ko": "페트로라텀",
    ...
    "cat": "크리닉",
    "mid": "보습",
    "role": "강력한 수분 차단 / 모발 끝 보호",
    "strength": "중",
    "feature": "밀폐 보습, 보호",
    "desc": "바셀린으로 알려진 성분으로 모발 끝에 발라 수분 증발을 차단하고 갈라짐을 방지한다. 매우 무거워 소량만 사용해야 한다.",
    "source": "system"
  },
  {
    "ko": "라놀린",
    ...
    "strength": "중",
    "feature": "고보습, 유연화",
    "desc": "양모에서 추출한 천연 왁스로 모발에 깊은 보습을 제공하고 뻣뻣한 모발을 유연하게 만든다. 건조하고 거친 모발에 효과적이지만 무거운 편이다.",
    "source": "system"
  },
  {
    "ko": "스쿠알란",
    ...
    "strength": "약",
    "feature": "경량 보습, 윤기",
    "desc": "올리브나 사탕수수 유래 탄화수소로 산화 안정성이 높고 가볍게 흡수된다. 끈적임 없이 모발에 자연스러운 윤기를 주며 산화되지 않는 장점이 있다.",
    "source": "system"
  },
  {
    "ko": "바오밥 오일",
    ...
    "strength": "중",
    "feature": "탄력, 영양",
    "desc": "아프리카 바오밥 나무 씨앗에서 추출한 오일로 올레산과 리놀레산이 풍부하다. 건조하고 탄력 없는 모발에 영양을 주고 탄력을 회복시킨다.",
    "source": "system"
  },
  {
    "ko": "아마씨 오일",
    ...
    "strength": "약",
    "feature": "광택, 곱슬 완화",
    "desc": "오메가-3가 풍부한 식물성 오일로 모발에 자연스러운 광택을 주고 곱슬기를 부드럽게 완화한다. 가벼워서 일상적인 사용에 적합하다.",
    "source": "system"
  },
  {
    "ko": "대마 씨 오일",
    "en": "Cannabis Sativa Seed Oil",
    "cat": "크리닉",
    "mid": "보습",
    "role": "모발 보습 / 두피 진정",
    "strength": "약",
    "feature": "보습, 진정",
    "desc": "오메가-3, 6, 9가 균형 잡힌 오일로 모발에 가벼운 보습을 주고 예민한 두피를 진정시킨다. CBD 성분과는 무관한 씨앗 오일이다.",
    "source": "system"
  },
  {
    "ko": "모링가 오일",
    ...
    "strength": "약",
    "feature": "보호, 항산화",
    "desc": "벤산으로도 불리며 산화 안정성이 매우 높다. 모발에 보호막을 형성해 미세먼지와 오염으로부터 보호하고 가벼운 보습을 제공한다.",
    "source": "system"
  },
  {
    "ko": "흑종초 오일",
    ...
    "strength": "약",
    "feature": "항염, 모발 강화",
    "desc": "블랙커민씨드 오일로도 불리며 티모퀴논 성분이 두피 염증을 완화한다. 모발을 강화하고 탈모 예방 보조 효과가 있다.",
    "source": "system"
  },
  {
    "ko": "동백꽃 추출물",
    "en": "Camellia Japonica Flower Extract",
    "cat": "크리닉",
    "mid": "보습",
    "role": "모발 보습 / 항산화",
    "strength": "약",
    "feature": "보습, 항산화",
    "desc": "동백꽃에서 추출한 성분으로 폴리페놀이 풍부해 모발의 산화 손상을 줄이고 보습을 제공한다. 동백 오일보다 가벼운 감촉이다.",
    "source": "system"
  },
  {
    "ko": "녹차 추출물",
    ...
    "strength": "약",
    "feature": "항산화, 피지 조절",
    "desc": "카테킨이 풍부해 두피의 산화 스트레스를 줄이고 과도한 피지 분비를 조절한다. 지성 두피 제품에 많이 사용된다.",
    "source": "system"
  },
  {
    "ko": "페퍼민트 오일",
    ...
    "strength": "중",
    "feature": "청량감, 혈행 촉진",
    "desc": "멘톨이 풍부한 에센셜 오일로 두피에 시원한 청량감을 주고 혈액 순환을 촉진한다. 과량 사용 시 두피 자극이 있을 수 있다.",
    "source": "system"
  },
  {
    "ko": "멘톨",
    ...
    "strength": "중",
    "feature": "청량, 가려움 완화",
    "desc": "박하에서 추출한 성분으로 두피에 시원한 느낌을 주고 가려움을 일시적으로 완화한다. 여름용 샴푸와 두피 토닉에 많이 사용된다.",
    "source": "system"
  },
  {
    "ko": "유칼립투스 오일",
    ...
    "strength": "중",
    "feature": "항균, 청량감",
    "desc": "유칼립톨 성분이 두피 세균을 억제하고 상쾌한 청량감을 준다. 비듬과 가려움 개선에 보조적으로 사용된다.",
    "source": "system"
  },
  {
    "ko": "레몬그라스 오일",
    "en": "Cymbopogon Citratus Oil",
    "cat": "두피",
    "mid": "항균",
    "role": "두피 항균 / 피지 조절",
    "strength": "약",
    "feature": "항균, 피지 조절",
    "desc": "시트랄 성분이 두피의 세균과 곰팡이를 억제하고 과도한 피지를 조절한다. 상쾌한 레몬 향이 특징이다.",
    "source": "system"
  },
  {
    "ko": "시더우드 오일",
    ...
    "strength": "약",
    "feature": "혈행 촉진, 탈모 예방",
    "desc": "시더우드 에센셜 오일로 두피 혈액 순환을 촉진하고 모근 강화를 돕는다. 아로마테라피에서 탈모 예방 목적으로 사용된다.",
    "source": "system"
  },
  {
    "ko": "일랑일랑 오일",
    ...
    "strength": "약",
    "feature": "보습, 피지 균형",
    "desc": "일랑일랑 꽃에서 추출한 에센셜 오일로 건조한 모발에 보습을 주고 두피의 피지 분비를 정상화한다. 달콤한 꽃향이 특징이다.",
    "source": "system"
  },
  {
    "ko": "클라리세이지 오일",
    ...
    "cat": "두피",
    "mid": "두피케어",
    "role": "두피 피지 조절 / 모발 성장 보조",
    "strength": "약",
    "feature": "피지 조절, 모발 성장",
    "desc": "클라리세이지에서 추출한 에센셜 오일로 두피의 과도한 피지를 조절하고 모발 성장을 촉진하는 데 보조적 역할을 한다.",
    "source": "system"
  },
  {
    "ko": "타임 오일",
    "en": "Thymus Vulgaris Oil",
    "cat": "두피",
    "mid": "항균",
    "role": "두피 강력 항균 / 비듬 억제",
    "strength": "중",
    "feature": "항균, 비듬 억제",
    "desc": "티몰 성분이 풍부해 강한 항균, 항진균 효과가 있다. 비듬과 두피 감염 개선에 효과적이지만 자극이 강해 희석하여 사용해야 한다.",
    "source": "system"
  },
  {
    "ko": "캐모마일 추출물",
    "en": "Chamomilla Recutita Extract",
    "cat": "두피",
    "mid": "두피케어",
    "role": "두피 진정 / 염증 완화",
    "strength": "약",
    "feature": "진정, 항염",
    "desc": "캐모마일에서 추출한 성분으로 비사보롤과 아줄렌이 두피 염증과 자극을 진정시킨다. 예민한 두피에 적합하다.",
    "source": "system"
  },
  {
    "ko": "비사보롤",
    ...
    "strength": "약",
    "feature": "진정, 항자극",
    "desc": "캐모마일에서 추출한 항염 성분으로 화학 시술 후 자극받은 두피를 빠르게 진정시킨다. 저자극이라 민감한 두피에도 안전하다.",
    "source": "system"
  },
  {
    "ko": "알란토인",
    ...
    "strength": "약",
    "feature": "보호, 회복",
    "desc": "컴프리에서 유래한 성분으로 두피의 자극을 줄이고 세포 재생을 촉진한다. 시술 후 예민해진 두피 회복에 도움을 준다.",
    "source": "system"
  },
  {
    "ko": "우레아",
    ...
    "strength": "중",
    "feature": "각질 연화, 보습",
    "desc": "피부의 자연 보습인자 중 하나로 두피 각질을 부드럽게 녹이고 수분을 깊이 공급한다. 건조하고 각질이 심한 두피에 효과적이다.",
    "source": "system"
  },
  {
    "ko": "소듐 락테이트",
    ...
    "strength": "약",
    "feature": "보습, 유연",
    "desc": "젖산나트륨으로 피부와 모발의 자연 보습인자와 유사한 성분이다. 수분을 끌어당겨 모발을 촉촉하고 유연하게 유지시킨다.",
    "source": "system"
  },
  {
    "ko": "글리콜산",
    ...
    "strength": "중",
    "feature": "각질 용해, AHA",
    "desc": "가장 작은 AHA로 침투력이 높아 두피 각질을 효과적으로 녹인다. 두피 스케일링 제품에 사용되며 과도하면 자극이 있을 수 있다.",
    "source": "system"
  },
  {
    "ko": "만델산",
    ...
    "strength": "약",
    "feature": "순한 각질 제거, 항균",
    "desc": "아몬드 유래 AHA로 분자가 커서 침투가 느리고 자극이 적다. 민감한 두피의 각질 관리에 적합하며 항균 효과도 있다.",
    "source": "system"
  },
  {
    "ko": "아젤라산",
    ...
    "cat": "두피",
    "mid": "두피케어",
    "role": "두피 항균 / DHT 억제 보조",
    "strength": "중",
    "feature": "항균, DHT 억제",
    "desc": "곡물 유래 디카르복실산으로 두피 세균을 억제하고 DHT(탈모 유발 호르몬) 생성을 일부 억제하는 효과가 보고되어 탈모 케어에 주목받는 성분이다.",
    "source": "system"
  },
  {
    "ko": "피리독신 HCl",
    ...
    "strength": "약",
    "feature": "피지 조절, 영양",
    "desc": "비타민 B6로 두피의 피지 분비를 조절하고 모발 케라틴 생성에 관여한다. 지성 두피 관리와 모발 건강 유지에 도움을 준다.",
    "source": "system"
  },
  {
    "ko": "리보플라빈",
    ...
    "cat": "두피",
    "mid": "두피케어",
    "role": "두피 세포 대사 지원 / 모발 성장",
    "strength": "약",
    "feature": "세포 대사, 모발 성장",
    "desc": "비타민 B2로 두피 세포의 에너지 대사를 지원한다. 부족 시 탈모와 지루성 피부염이 나타날 수 있어 두피 케어 제품에 보조적으로 사용된다.",
    "source": "system"
  },
  {
    "ko": "폴산",
    ...
    "cat": "두피",
    "mid": "두피케어",
    "role": "모낭 세포 분열 지원 / 모발 성장",
    "strength": "약",
    "feature": "세포 분열, 모발 성장",
    "desc": "비타민 B9로 모낭 세포의 정상적인 분열에 필요한 성분이다. 부족 시 모발 성장이 둔화될 수 있어 탈모 케어 제품에 포함된다.",
    "source": "system"
  },
  {
    "ko": "토코페릴 아세테이트",
    ...
    "strength": "약",
    "feature": "항산화, 안정화",
    "desc": "비타민 E의 안정화 형태로 산화에 강하고 모발과 두피를 자외선과 열 손상으로부터 보호한다. 토코페롤보다 안정적이어서 제품에 많이 사용된다.",
    "source": "system"
  },
  {
    "ko": "레티놀",
    ...
    "strength": "중",
    "feature": "세포 재생, 모공 관리",
    "desc": "비타민 A 유도체로 두피 세포 턴오버를 촉진하고 모공을 정돈한다. 두피 노화 케어에 사용되지만 자극이 있을 수 있어 점진적 사용을 권장한다.",
    "source": "system"
  },
  {
    "ko": "셀레늄 설파이드",
    ...
    "cat": "두피",
    "mid": "항비듬",
    "role": "비듬균 강력 억제 / 지루성 두피",
    "strength": "강",
    "feature": "강력 항비듬, 각질 억제",
    "desc": "강한 항진균 성분으로 심한 비듬과 지루성 두피염에 사용된다. 두피 세포 증식을 억제하고 비듬 원인균을 강하게 잡는다. 사용 후 충분한 헹굼이 필요하다.",
    "source": "system"
  },
  {
    "ko": "케토코나졸",
    ...
    "cat": "두피",
    "mid": "항비듬",
    "role": "항진균 / 비듬·지루성 두피 치료",
    "strength": "강",
    "feature": "강력 항진균, 비듬 치료",
    "desc": "의약품 등급 항진균제로 심한 비듬과 지루성 두피염에 사용된다. DHT 억제 효과도 보고되어 탈모 방지 목적으로도 활용된다.",
    "source": "system"
  },
  {
    "ko": "소듐 하이드록사이드",
    ...
    "cat": "세정",
    "mid": "pH조절",
    "role": "제품 pH 상승 / 알칼리 조절",
    "strength": "강",
    "feature": "pH 조절, 알칼리",
    "desc": "소량으로 제품의 pH를 빠르게 올리는 데 사용되는 강알칼리 성분이다. 겔화제 중화나 염모제 pH 조절 등에 미량 사용된다.",
    "source": "system"
  },
  {
    "ko": "인산",
    ...
    "cat": "세정",
    "mid": "pH조절",
    "role": "제품 pH 강하 / 산화제 안정",
    "strength": "약",
    "feature": "pH 조절, 안정화",
    "desc": "무기산으로 제품의 pH를 낮추는 데 사용된다. 산화제(2제)의 pH를 안정적으로 유지하는 역할을 하며 미량 사용된다.",
    "source": "system"
  },
  {
    "ko": "아스코르빌 글루코사이드",
    "en": "Ascorbyl Glucoside",
    "cat": "두피",
    "mid": "항산화",
    "role": "두피 항산화 / 색소 침착 개선",
    "strength": "약",
    "feature": "항산화, 안정화 비타민C",
    "desc": "비타민 C의 안정화 형태로 두피에서 서서히 활성화되어 항산화 효과를 발휘한다. 두피 색소 침착 개선에도 도움을 준다.",
    "source": "system"
  },
  {
    "ko": "페룰산",
    ...
    "cat": "크리닉",
    "mid": "항산화",
    "role": "모발 산화 방지 / UV 보호 보조",
    "strength": "약",
    "feature": "항산화, UV 보호",
    "desc": "식물 세포벽에서 발견되는 강력한 항산화 성분으로 자외선에 의한 모발 손상을 줄이고 비타민 C, E의 효과를 높여준다.",
    "source": "system"
  },
  {
    "ko": "레스베라트롤",
    ...
    "strength": "약",
    "feature": "항산화, 항노화",
    "desc": "포도와 와인에서 발견되는 폴리페놀로 강력한 항산화 효과가 있다. 두피의 산화 스트레스를 줄이고 모낭 노화를 지연시키는 데 도움을 준다.",
    "source": "system"
  },
  {
    "ko": "코엔자임 Q10",
    ...
    "strength": "약",
    "feature": "세포 에너지, 항산화",
    "desc": "세포 에너지 생성에 관여하는 항산화 성분으로 두피 세포의 활력을 높이고 산화 스트레스를 줄인다. 두피 에이징 케어 제품에 사용된다.",
    "source": "system"
  },
  {
    "ko": "글루타치온",
    ...
    "strength": "약",
    "feature": "해독, 항산화",
    "desc": "체내 대표 항산화 물질로 두피 세포의 독소를 해독하고 산화 손상을 막는다. 모발 멜라닌 생성에도 영향을 미친다.",
    "source": "system"
  },
  {
    "ko": "소듐 아스코빌 포스페이트",
    "en": "Sodium Ascorbyl Phosphate",
    "cat": "두피",
    "mid": "항산화",
    "role": "두피 항산화 / 항균",
    "strength": "약",
    "feature": "항산화, 항균",
    "desc": "안정화 비타민 C 유도체로 두피에서 항산화 및 항균 작용을 한다. 여드름성 두피 트러블 개선에도 보조적으로 사용된다.",
    "source": "system"
  },
  {
    "ko": "스피루리나 추출물",
    "en": "Spirulina Platensis Extract",
    "cat": "크리닉",
    "mid": "단백질",
    "role": "모발 영양 / 아미노산 공급",
    "strength": "약",
    "feature": "영양, 아미노산",
    "desc": "스피루리나 미세조류에서 추출한 성분으로 아미노산과 미네랄이 풍부하다. 모발에 영양을 공급하고 건강한 상태를 유지하는 데 도움을 준다.",
    "source": "system"
  },
  {
    "ko": "해조 추출물",
    ...
    "strength": "약",
    "feature": "보습, 미네랄",
    "desc": "해조류에서 추출한 성분으로 미네랄과 다당류가 풍부하다. 모발에 보습과 영양을 동시에 공급하며 건조한 모발에 생기를 준다.",
    "source": "system"
  },
  {
    "ko": "대두 레시틴",
    ...
    "strength": "약",
    "feature": "유화, 보습",
    "desc": "대두에서 추출한 인지질로 유화제 역할과 보습 효과를 겸한다. 모발 큐티클 사이 빈틈을 채우고 수분을 유지시킨다.",
    "source": "system"
  },
  {
    "ko": "콜레스테롤",
    ...
    "cat": "크리닉",
    "mid": "보습",
    "role": "모발 지질 보충 / 큐티클 강화",
    "strength": "중",
    "feature": "지질 보충, 큐티클 강화",
    "desc": "양모에서 추출한 지질 성분으로 손상된 모발의 지질층을 보충하고 큐티클을 강화한다. 딥 컨디셔닝 제품에 많이 사용된다.",
    "source": "system"
  },
  {
    "ko": "18-MEA",
    "en": "18-Methyl Eicosanoic Acid",
    "cat": "크리닉",
    "mid": "코팅",
    "role": "버진모 표면 복원 / 소수성 코팅",
    "strength": "중",
    "feature": "큐티클 복원, 소수성",
    "desc": "건강한 모발 표면에 존재하는 지방산으로 시술 시 손실된다. 이를 보충하면 모발 표면의 소수성이 회복되어 수분이 과도하게 침투하는 것을 막고 자연스러운 광택이 난다.",
    "source": "system"
  },
  {
    "ko": "카르니틴",
    ...
    "cat": "두피",
    "mid": "두피케어",
    "role": "모낭 에너지 공급 / 모발 성장",
    "strength": "약",
    "feature": "에너지 공급, 모발 성장",
    "desc": "지방산을 세포 내 미토콘드리아로 운반해 에너지를 생성하는 역할을 한다. 모낭 세포에 에너지를 공급해 모발 성장을 돕는다.",
    "source": "system"
  },
  {
    "ko": "사과 줄기세포 추출물",
    "en": "Malus Domestica Fruit Cell Culture Extract",
    "cat": "두피",
    "mid": "탈모케어",
    "role": "모낭 줄기세포 보호 / 노화 방지",
    "strength": "약",
    "feature": "줄기세포 보호, 항노화",
    "desc": "스위스산 희귀 사과 줄기세포에서 추출한 성분으로 모낭 줄기세포의 수명을 연장하고 노화를 지연시키는 데 도움을 준다.",
    "source": "system"
  },
  {
    "ko": "피토스핑고신",
    ...
    "strength": "약",
    "feature": "장벽 강화, 항균",
    "desc": "두피 장벽의 구성 성분으로 세라마이드 생성을 촉진하고 항균 효과가 있다. 두피 장벽이 약해진 경우 회복을 돕는다.",
    "source": "system"
  },
  {
    "ko": "프로바이오틱스 발효 추출물",
    "en": "Lactobacillus Ferment Lysate",
    "cat": "두피",
    "mid": "두피케어",
    "role": "두피 마이크로바이옴 균형 / 진정",
    "strength": "약",
    "feature": "마이크로바이옴, 진정",
    "desc": "유산균 발효 추출물로 두피의 미생물 균형을 잡아주고 예민한 두피를 진정시킨다. 두피 마이크로바이옴 케어 제품에 사용된다.",
    "source": "system"
  },
  {
    "ko": "프리바이오틱스 이눌린",
    ...
    "cat": "두피",
    "mid": "두피케어",
    "role": "두피 유익균 지원 / 균형 유지",
    "strength": "약",
    "feature": "프리바이오틱스, 균형",
    "desc": "식물 유래 올리고당으로 두피의 유익한 미생물에 영양을 공급해 건강한 마이크로바이옴 환경을 유지하는 데 도움을 준다.",
    "source": "system"
  },
  {
    "ko": "피넨",
    ...
    "strength": "약",
    "feature": "소나무 향, 항균",
    "desc": "소나무와 침엽수에서 추출한 천연 향 성분으로 산뜻한 숲 향을 준다. 약한 항균 효과도 있다.",
    "source": "system"
  },
  {
    "ko": "리날룰",
    ...
    "strength": "약",
    "feature": "꽃 향, 진정",
    "desc": "라벤더와 다양한 꽃에서 발견되는 천연 향 성분이다. 심리적 진정 효과가 있으나 일부에서 알레르기를 유발할 수 있다.",
    "source": "system"
  },
  {
    "ko": "게라니올",
    ...
    "strength": "약",
    "feature": "장미 향, 천연 향",
    "desc": "장미와 제라늄에서 발견되는 천연 향 성분으로 달콤한 꽃향을 부여한다. EU에서 알레르기 유발 가능 향료로 표시가 필요하다.",
    "source": "system"
  },
  {
    "ko": "시트로넬올",
    ...
    "strength": "약",
    "feature": "장미 향, 은은함",
    "desc": "장미와 제라늄에서 추출되는 천연 향 성분으로 은은한 꽃향을 부여한다. 알레르기 유발 가능성이 있어 표시가 필요한 향료다.",
    "source": "system"
  },
  {
    "ko": "쿠마린",
    ...
    "strength": "약",
    "feature": "달콤한 향, 향 고정",
    "desc": "통카빈에서 발견되는 향 성분으로 바닐라와 유사한 달콤한 향을 내며 향의 지속력을 높인다.",
    "source": "system"
  },
  {
    "ko": "하이드록시시트로넬알",
    ...
    "strength": "약",
    "feature": "백합 향, 꽃향",
    "desc": "은방울꽃과 백합 향을 내는 합성 향료다. 고급스러운 꽃향을 만드는 데 사용되며 알레르기 표시가 필요한 향료 중 하나다.",
    "source": "system"
  },
  {
    "ko": "헥실 신나말",
    ...
    "strength": "약",
    "feature": "캐모마일 향, 향료",
    "desc": "캐모마일과 유사한 꽃향을 내는 향료 성분이다. 향수와 헤어 제품에 널리 사용되며 알레르기 표시가 필요하다.",
    "source": "system"
  },
  {
    "ko": "소듐 메틸코코일 타우레이트",
    "en": "Sodium Methyl Cocoyl Taurate",
    "cat": "세정",
    "mid": "계면활성제",
    "role": "저자극 세정 / 풍부한 거품",
    "strength": "약",
    "feature": "저자극, 부드러운 거품",
    "desc": "타우린 유래 계면활성제로 자극이 매우 낮으면서 풍부한 거품을 만든다. 컬러 시술 후 색빠짐을 최소화하는 샴푸에 적합하다.",
    "source": "system"
  },
  {
    "ko": "소듐 라우로일 사르코시네이트",
    ...
    "role": "부드러운 세정 / 거품 보조",
    "strength": "약",
    "feature": "부드러운 세정, 거품 보조",
    "desc": "아미노산 유래 계면활성제로 자극이 적고 부드러운 세정력을 제공한다. 주 계면활성제의 거품을 안정시키는 보조 역할을 한다.",
    "source": "system"
  },
  {
    "ko": "소듐 C14-16 올레핀 설포네이트",
    "en": "Sodium C14-16 Olefin Sulfonate",
    "cat": "세정",
    "mid": "계면활성제",
    "role": "깊은 세정 / 설페이트 프리 대안",
    "strength": "중",
    "feature": "깊은 세정, 설페이트 프리",
    "desc": "설페이트 프리 제품에서 SLS를 대체하는 계면활성제다. 세정력이 강하면서 설페이트보다 자극이 적어 클래리파잉 샴푸에 많이 사용된다.",
    "source": "system"
  },
  {
    "ko": "라우라미도프로필 베타인",
    "en": "Lauramidopropyl Betaine",
    "cat": "세정",
    "mid": "계면활성제",
    "role": "저자극 세정 / 거품 안정",
    "strength": "약",
    "feature": "저자극, 거품 안정",
    "desc": "코카미도프로필 베타인과 유사한 양쪽성 계면활성제로 자극이 매우 낮다. 민감한 두피용 샴푸에서 보조 계면활성제로 사용된다.",
    "source": "system"
  },
  {
    "ko": "라우릴 글루코사이드",
    ...
    "strength": "약",
    "feature": "천연 유래, 저자극",
    "desc": "코코넛과 포도당에서 만든 비이온 계면활성제로 자극이 매우 적다. EWG 1등급으로 민감 두피 제품에 적합하다.",
    "source": "system"
  },
  {
    "ko": "폴리쿼터늄-22",
    ...
    "strength": "중",
    "feature": "볼륨, 스타일 유지",
    "desc": "양이온 폴리머로 모발에 볼륨을 주고 스타일 유지력을 높인다. 볼류마이징 무스와 스프레이에 많이 사용된다.",
    "source": "system"
  },
  {
    "ko": "하이드록시프로필트리모늄 하이알루로네이트",
    "en": "Hydroxypropyltrimonium Hyaluronate",
    "cat": "크리닉",
    "mid": "보습",
    "role": "모발 표면 보습 고정",
    "strength": "약",
    "feature": "보습 고정, 컨디셔닝",
    "desc": "양이온화된 히알루론산으로 모발 표면에 결합하여 세정 후에도 보습 효과가 유지된다. 일반 히알루론산보다 모발에 잘 달라붙는다.",
    "source": "system"
  },
  {
    "ko": "폴리글루타민산",
    "en": "Polyglutamic Acid",
    "cat": "크리닉",
    "mid": "보습",
    "role": "고보습 피막 / 수분 유지",
    "strength": "약",
    "feature": "고보습, 수분 피막",
    "desc": "히알루론산의 10배 이상 수분을 잡는다고 알려진 바이오 폴리머다. 모발 표면에 수분 피막을 형성해 건조한 환경에서도 촉촉함을 유지한다.",
    "source": "system"
  },
  {
    "ko": "메도우폼 오일",
    "en": "Limnanthes Alba Seed Oil",
    "cat": "크리닉",
    "mid": "보습",
    "role": "모발 보호 / 열 보호",
    "strength": "약",
    "feature": "보호, 열 안정",
    "desc": "산화 안정성이 매우 높은 식물 오일로 모발에 보호막을 형성한다. 열에 안정적이어서 드라이와 고데기 사용 전 열 보호에 효과적이다.",
    "source": "system"
  },
  {
    "ko": "크라메리아 트리안드라 추출물",
    "en": "Krameria Triandra Root Extract",
    "cat": "크리닉",
    "mid": "단백질",
    "role": "모발 결합 강화 / 손상 보수",
    "strength": "중",
    "feature": "결합 강화, 손상 보수",
    "desc": "라타니아 뿌리에서 추출한 성분으로 모발 내부 결합을 강화하고 화학 시술로 인한 손상을 보수하는 데 도움을 준다. 본드 리페어 제품에 사용된다.",
    "source": "system"
  },
  {
    "ko": "비스-디글리세릴 폴리아실아디페이트-2",
    "en": "Bis-Diglyceryl Polyacyladipate-2",
    "cat": "크리닉",
    "mid": "보습",
    "role": "모발 유연화 / 실리콘 대체 코팅",
    "strength": "약",
    "feature": "유연화, 실리콘 프리",
    "desc": "식물 유래 에스터로 실리콘 없이 모발에 부드러운 감촉과 윤기를 준다. 실리콘 프리 제품에서 다이메티콘 대체 성분으로 사용된다.",
    "source": "system"
  },
  {
    "ko": "브라시카 알코올",
    ...
    "role": "천연 유래 유연 / 제형 안정",
    "strength": "약",
    "feature": "천연 유연제, 제형 안정",
    "desc": "유채꽃에서 추출한 지방 알코올로 세틸 알코올의 천연 대안이다. 컨디셔너에 부드러운 질감을 부여하고 모발을 유연하게 만든다.",
    "source": "system"
  },
  {
    "ko": "이눌린 라우릴 카바메이트",
    "en": "Inulin Lauryl Carbamate",
    "cat": "크리닉",
    "mid": "코팅",
    "role": "천연 컨디셔닝 / 실리콘 대체",
    "strength": "약",
    "feature": "천연 컨디셔닝, 실리콘 대체",
    "desc": "이눌린 유래 천연 컨디셔닝제로 모발에 부드러운 감촉을 주면서 정전기를 억제한다. 클린 뷰티 제품에서 실리콘과 쿼터늄 대체로 사용된다.",
    "source": "system"
  },
  {
    "ko": "소듐 벤조트리아졸릴부틸페놀 설포네이트",
    "en": "Sodium Benzotriazolybutylphenol Sulfonate",
    "cat": "크리닉",
    "mid": "자외선차단",
    "role": "모발 UV 차단 / 컬러 퇴색 방지",
    "strength": "약",
    "feature": "UV 차단, 컬러 보호",
    "desc": "수용성 자외선 흡수제로 자외선에 의한 모발 변색과 염색 퇴색을 방지한다. 컬러 케어 샴푸와 컨디셔너에 사용된다.",
    "source": "system"
  },
  {
    "ko": "에틸헥실 메톡시신나메이트",
    "en": "Ethylhexyl Methoxycinnamate",
    "cat": "크리닉",
    "mid": "자외선차단",
    "role": "UVB 차단 / 모발 보호",
    "strength": "약",
    "feature": "UVB 차단, 모발 보호",
    "desc": "UVB 흡수제로 자외선에 의한 모발 단백질 손상과 염색 퇴색을 방지한다. 리브인 제품과 헤어 미스트에 사용된다.",
    "source": "system"
  },
  {
    "ko": "벤조페논-4",
    ...
    "cat": "크리닉",
    "mid": "자외선차단",
    "role": "UVA/UVB 차단 / 제품 안정",
    "strength": "약",
    "feature": "UV 차단, 제품 안정",
    "desc": "수용성 자외선 흡수제로 UVA와 UVB 모두를 차단한다. 모발 보호뿐 아니라 제품 자체의 변색과 변질을 막는 데에도 사용된다.",
    "source": "system"
  },
  {
    "ko": "솔비탄 세스퀴올리에이트",
    "en": "Sorbitan Sesquioleate",
    "cat": "크리닉",
    "mid": "유화",
    "role": "W/O 유화 / 두꺼운 크림 제형",
    "strength": "약",
    "feature": "유화, 두꺼운 질감",
    "desc": "오일 연속상 유화에 사용되는 유화제로 두껍고 풍성한 크림 질감을 만든다. 딥 컨디셔닝 마스크와 헤어팩에 사용된다.",
    "source": "system"
  },
  {
    "ko": "아크릴레이트 코폴리머",
    ...
    "strength": "중",
    "feature": "고정력, 방수 피막",
    "desc": "헤어스프레이의 핵심 피막 형성 폴리머로 모발에 투명한 피막을 만들어 스타일을 고정한다. 습기에 강해 방수 효과가 있다.",
    "source": "system"
  },
  {
    "ko": "부탄",
    ...
    "cat": "세정",
    "mid": "추진제",
    "role": "스프레이 분사 / 에어로졸 추진",
    "strength": "약",
    "feature": "추진제, 분사",
    "desc": "에어로졸 제품(헤어스프레이, 드라이샴푸)의 추진제로 내용물을 미세한 입자로 분사시킨다. 인화성이 있어 화기 근처 사용을 피해야 한다.",
    "source": "system"
  },
  {
    "ko": "프로판",
    ...
    "strength": "약",
    "feature": "추진제, 미세 분사",
    "desc": "부탄과 함께 에어로졸 추진제로 사용되어 제품을 미세하게 분사한다. 분사 강도와 입자 크기를 조절하기 위해 부탄과 혼합 비율을 조정한다.",
    "source": "system"
  },
  {
    "ko": "이소부탄",
    ...
    "strength": "약",
    "feature": "추진제, 속건",
    "desc": "에어로졸 추진제로 부탄보다 빠르게 기화하여 분사 후 빠른 건조를 돕는다. 드라이 샴푸와 텍스처 스프레이에 사용된다.",
    "source": "system"
  },
  {
    "ko": "SD 알코올 40-B",
    ...
    "strength": "중",
    "feature": "속건, 유분 제거",
    "desc": "변성 에탄올로 헤어스프레이와 무스에서 제품이 빠르게 마르도록 돕는다. 두피의 유분을 제거하는 효과도 있지만 과도하면 건조해질 수 있다.",
    "source": "system"
  },
  {
    "ko": "실리카",
    ...
    "strength": "약",
    "feature": "매트 질감, 유분 흡수",
    "desc": "미세한 실리카 입자가 모발의 유분을 흡수하고 매트한 질감을 만든다. 볼류마이징 파우더와 드라이 샴푸에 사용된다.",
    "source": "system"
  },
  {
    "ko": "카올린",
    ...
    "strength": "약",
    "feature": "유분 흡착, 디톡스",
    "desc": "백토라고도 불리는 점토 성분으로 두피의 과도한 유분과 노폐물을 흡착한다. 두피 클레이 마스크와 디톡스 샴푸에 사용된다.",
    "source": "system"
  },
  {
    "ko": "벤토나이트",
    ...
    "cat": "두피",
    "mid": "흡수제",
    "role": "강력한 독소 흡착 / 두피 세정",
    "strength": "중",
    "feature": "독소 흡착, 강한 세정",
    "desc": "화산재 유래 점토로 흡착력이 매우 강하다. 두피의 독소, 미네랄 침착, 제품 잔여물을 강하게 빨아들여 두피를 깊이 세정한다.",
    "source": "system"
  },
  {
    "ko": "활성탄",
    ...
    "strength": "중",
    "feature": "독소 흡착, 정화",
    "desc": "미세 기공이 많아 독소와 불순물을 강하게 흡착하는 성분이다. 두피 디톡스 샴푸에서 모공 속 노폐물과 제품 잔여물을 제거하는 데 사용된다.",
    "source": "system"
  },
  {
    "ko": "소금",
    ...
    "strength": "약",
    "feature": "텍스처, 볼륨",
    "desc": "씨솔트 스프레이의 핵심 성분으로 모발에 무광택의 비치웨이브 질감과 볼륨을 준다. 과도하면 모발이 건조해질 수 있다.",
    "source": "system"
  },
  {
    "ko": "클로르헥시딘 디글루코네이트",
    "en": "Chlorhexidine Digluconate",
    "cat": "두피",
    "mid": "항균",
    "role": "두피 살균 / 감염 예방",
    "strength": "중",
    "feature": "살균, 감염 예방",
    "desc": "광범위 항균제로 두피의 세균 감염을 예방한다. 시술 후 두피 상처 부위의 이차 감염을 방지하는 데 사용된다.",
    "source": "system"
  },
  {
    "ko": "트리클로산",
    ...
    "strength": "중",
    "feature": "항균, 비듬 보조",
    "desc": "광범위 항균 성분으로 비듬 억제에 보조적으로 사용되었다. 환경 및 건강 우려로 많은 국가에서 사용이 제한되고 있다.",
    "source": "system"
  },
  {
    "ko": "옥토피록스",
    ...
    "cat": "두피",
    "mid": "항비듬",
    "role": "비듬균 억제 / 두피 각질 조절",
    "strength": "중",
    "feature": "항진균, 각질 조절",
    "desc": "피록톤 올아민의 다른 이름으로 비듬 원인균을 억제하면서 자극이 적다. 매일 사용하는 샴푸에도 적합한 항비듬 성분이다.",
    "source": "system"
  },
  {
    "ko": "언데실레닉 애씨드",
    ...
    "strength": "약",
    "feature": "항진균, 균형",
    "desc": "피마자유 유래 지방산으로 천연 항진균 효과가 있다. 두피의 곰팡이 증식을 억제하고 건강한 두피 환경을 유지하는 데 도움을 준다.",
    "source": "system"
  },
  {
    "ko": "p-톨루엔디아민 설페이트",
    "en": "p-Toluenediamine Sulfate",
    "cat": "염모제",
    "mid": "염료",
    "role": "영구 염색 발색 / 밝은 색상",
    "strength": "강",
    "feature": "영구 발색, 밝은 색조",
    "desc": "PTD로 불리는 영구 염료로 PPD보다 자극이 적으면서 밝고 선명한 색상을 구현한다. 일부 제품에서 PPD 대체로 사용된다.",
    "source": "system"
  },
  {
    "ko": "하이드록시에틸-p-페닐렌디아민 설페이트",
    "en": "Hydroxyethyl-p-Phenylenediamine Sulfate",
    "cat": "염모제",
    "mid": "염료",
    "role": "저자극 영구 발색",
    "strength": "중",
    "feature": "저자극 염료, 영구 발색",
    "desc": "PPD의 저자극 대안으로 개발된 산화 염료다. 알레르기 발생 빈도가 PPD보다 낮으면서 비슷한 발색력을 낸다.",
    "source": "system"
  },
  {
    "ko": "HC 블루 No.2",
    ...
    "strength": "약",
    "feature": "반영구, 블루 색조",
    "desc": "반영구 염모제에 사용되는 직접 염료로 과산화수소 없이 모발 표면에 푸른 색소를 입힌다. 세정 시 점차 퇴색된다.",
    "source": "system"
  },
  {
    "ko": "HC 레드 No.3",
    ...
    "strength": "약",
    "feature": "반영구, 레드 색조",
    "desc": "반영구 직접 염료로 붉은 계열 색소를 모발에 입힌다. 산화제 없이 작용하며 샴푸할수록 점차 빠진다.",
    "source": "system"
  },
  {
    "ko": "베이직 바이올렛 2",
    ...
    "cat": "염모제",
    "mid": "염료",
    "role": "보라색 직접 염료 / 노랑 보색중화",
    "strength": "약",
    "feature": "보라 색조, 보색중화",
    "desc": "양이온 직접 염료로 보라색을 발색하며 노랑기 보색중화에도 사용된다. 보라 샴푸(퍼플 샴푸)의 핵심 색소다.",
    "source": "system"
  },
  {
    "ko": "베이직 블루 99",
    ...
    "strength": "약",
    "feature": "블루 색조, 직접 염료",
    "desc": "양이온 직접 염료로 밝은 블루 색상을 발색한다. 컬러 트리트먼트와 컬러 샴푸에 사용되며 주황기 보색중화에도 활용된다.",
    "source": "system"
  },
  {
    "ko": "베이직 레드 76",
    ...
    "strength": "약",
    "feature": "레드 색조, 직접 염료",
    "desc": "양이온 직접 염료로 선명한 붉은 색상을 발색한다. 레드 컬러 유지 트리트먼트에 사용되며 세정 시 점차 퇴색된다.",
    "source": "system"
  },
  {
    "ko": "베이직 옐로우 87",
    ...
    "role": "노란색 직접 염료 / 골드 톤",
    "strength": "약",
    "feature": "옐로우 색조, 직접 염료",
    "desc": "양이온 직접 염료로 노랑~골드 색상을 발색한다. 다른 직접 염료와 혼합하여 다양한 색조를 만드는 데 사용된다.",
    "source": "system"
  },
  {
    "ko": "베이직 브라운 16",
    ...
    "role": "갈색 직접 염료 / 커버링",
    "strength": "약",
    "feature": "브라운 색조, 직접 염료",
    "desc": "양이온 직접 염료로 자연스러운 갈색을 발색한다. 새치 커버링 트리트먼트와 컬러 샴푸에 사용된다.",
    "source": "system"
  },
  {
    "ko": "과탄산나트륨",
    "en": "Sodium Percarbonate",
    "cat": "염모제",
    "mid": "산화제",
    "role": "산소 방출 / 온화한 탈색",
    "strength": "중",
    "feature": "산소 발생, 온화한 탈색",
    "desc": "물에 녹으면 과산화수소를 방출하는 산소계 표백제다. 탈색 파우더에서 퍼설페이트보다 온화한 탈색 작용을 한다.",
    "source": "system"
  },
  {
    "ko": "세테아리모늄 클로라이드",
    "en": "Cetearamonium Chloride",
    "cat": "크리닉",
    "mid": "코팅",
    "role": "강력한 컨디셔닝 / 부드러운 감촉",
    "strength": "중",
    "feature": "강한 컨디셔닝, 부드러움",
    "desc": "세틸 트리모늄과 스테아릴 트리모늄의 혼합 양이온으로 강력한 컨디셔닝 효과를 낸다. 손상이 심한 모발용 트리트먼트에 사용된다.",
    "source": "system"
  },
  {
    "ko": "디스테아릴디모늄 클로라이드",
    "en": "Distearyldimonium Chloride",
    "cat": "크리닉",
    "mid": "코팅",
    "role": "강력한 컨디셔닝 / 정전기 억제",
    "strength": "강",
    "feature": "강한 컨디셔닝, 정전기 억제",
    "desc": "이중 쇄 양이온 계면활성제로 컨디셔닝 효과가 매우 강하다. 심하게 손상된 모발을 부드럽게 만들고 정전기를 강하게 억제한다.",
    "source": "system"
  },
  {
    "ko": "하이드록시에틸 우레아",
    "en": "Hydroxyethyl Urea",
    "cat": "크리닉",
    "mid": "보습",
    "role": "비끈적 보습 / 수분 유지",
    "strength": "약",
    "feature": "비끈적 보습, 수분",
    "desc": "우레아 유도체로 글리세린보다 끈적임이 적으면서 유사한 보습력을 가진다. 가벼운 보습감을 원하는 리브인 제품에 적합하다.",
    "source": "system"
  },
  {
    "ko": "펜틸렌 글라이콜",
    ...
    "strength": "약",
    "feature": "보습, 방부 보조",
    "desc": "보습제이자 항균 보조제로 페녹시에탄올과 함께 사용하면 보존력이 향상된다. 프로필렌 글라이콜보다 자극이 적다.",
    "source": "system"
  },
  {
    "ko": "감마도코사락톤",
    "en": "Gamma-Docosalactone",
    "cat": "크리닉",
    "mid": "코팅",
    "role": "열 활성 큐티클 보수 / 윤기",
    "strength": "중",
    "feature": "열 활성 보수, 윤기",
    "desc": "열(드라이, 고데기)을 가하면 모발 큐티클에 공유결합으로 붙어 손상을 보수하는 식물 유래 락톤이다. 세정 후에도 효과가 유지되며 지속적 사용 시 모발 상태가 개선된다.",
    "source": "system"
  },
  {
    "ko": "말레산",
    ...
    "cat": "크리닉",
    "mid": "결합제",
    "role": "모발 결합 재형성 / 본드 리페어",
    "strength": "중",
    "feature": "결합 재형성, 본드 리페어",
    "desc": "모발 내부의 끊어진 이황화 결합을 재형성하는 데 도움을 주는 유기산이다. 올라플렉스 등 본드 리페어 제품의 핵심 원리에 사용되는 성분이다.",
    "source": "system"
  },
  {
    "ko": "비스아미노프로필 디글리콜 디말레이트",
    "en": "Bis-Aminopropyl Diglycol Dimaleate",
    "cat": "크리닉",
    "mid": "결합제",
    "role": "이황화 결합 보수 / 시술 중 손상 방지",
    "strength": "중",
    "feature": "결합 보수, 손상 방지",
    "desc": "올라플렉스의 핵심 특허 성분으로 시술 중 끊어지는 이황화 결합을 재연결한다. 탈색, 염색, 펌 시술 시 함께 사용하면 모발 손상을 크게 줄인다.",
    "source": "system"
  },
  {
    "ko": "숙신산",
    ...
    "strength": "약",
    "feature": "pH 완충, 수렴",
    "desc": "디카르복실산으로 시술 후 모발 pH를 안정적으로 낮추는 완충 역할을 한다. 산처리제와 후처리제에 사용된다.",
    "source": "system"
  },
  {
    "ko": "풀러렌",
    ...
    "strength": "약",
    "feature": "강력 항산화, 보호",
    "desc": "탄소 나노 구조체로 비타민 C의 수백 배 항산화 효과가 보고된 프리미엄 성분이다. 모발과 두피의 산화 손상을 줄이는 데 사용된다.",
    "source": "system"
  },
  {
    "ko": "소듐 폴리아스파테이트",
    "en": "Sodium Polyaspartate",
    "cat": "크리닉",
    "mid": "보습",
    "role": "보습 / 큐티클 보호",
    "strength": "약",
    "feature": "보습, 보호",
    "desc": "아미노산 유래 폴리머로 모발에 수분을 유지시키고 큐티클을 보호하는 피막을 형성한다. 생분해성이 높아 친환경 제품에 적합하다.",
    "source": "system"
  },
  {
    "ko": "세피캡",
    "en": "Sepirose S Powder",
    "cat": "크리닉",
    "mid": "보습",
    "role": "매끄러운 질감 / 파우더리 피니시",
    "strength": "약",
    "feature": "매끄러움, 파우더리",
    "desc": "장미 유래 파우더 성분으로 모발과 두피에 부드럽고 매끄러운 질감을 부여한다. 스타일링 파우더에 사용되기도 한다.",
    "source": "system"
  },
  {
    "ko": "사이클로덱스트린",
    ...
    "strength": "약",
    "feature": "악취 흡착, 향 유지",
    "desc": "환형 올리고당으로 불쾌한 냄새 분자를 가두어 없애고 향료를 안정적으로 유지시킨다. 두피 냄새 케어 제품에 사용된다.",
    "source": "system"
  },
  {
    "ko": "시스테인 HCl",
    ...
    "cat": "크리닉",
    "mid": "단백질",
    "role": "모발 결합 보강 / 시술 후 보수",
    "strength": "약",
    "feature": "결합 보강, 보수",
    "desc": "시스틴의 환원형 아미노산으로 모발 내부 이황화 결합 형성에 참여한다. 펌이나 염색 후 손상된 결합을 보수하는 후처리제에 사용된다.",
    "source": "system"
  },
  {
    "ko": "세린",
    ...
    "cat": "크리닉",
    "mid": "단백질",
    "role": "모발 수분 유지 / 아미노산 보충",
    "strength": "약",
    "feature": "보습, 아미노산",
    "desc": "모발 케라틴에 포함된 아미노산으로 수분을 끌어당겨 모발을 촉촉하게 유지한다. 아미노산 복합 성분의 일부로 사용된다.",
    "source": "system"
  },
  {
    "ko": "프롤린",
    ...
    "strength": "약",
    "feature": "구조 지원, 탄력",
    "desc": "콜라겐과 케라틴의 주요 아미노산으로 모발의 구조적 안정성과 탄력을 유지하는 데 기여한다.",
    "source": "system"
  },
  {
    "ko": "라이신",
    ...
    "strength": "약",
    "feature": "강도, 영양",
    "desc": "필수 아미노산으로 모발 케라틴 생성에 관여하고 철분 흡수를 돕는다. 탈모와 모발 약화 예방에 보조적으로 사용된다.",
    "source": "system"
  },
  {
    "ko": "메티오닌",
    ...
    "strength": "약",
    "feature": "성장 보조, 황 공급",
    "desc": "황을 포함하는 필수 아미노산으로 모발 케라틴의 이황화 결합 형성에 필요하다. 모발 성장과 강도 유지에 도움을 준다.",
    "source": "system"
  },
  {
    "ko": "글리신",
    ...
    "strength": "약",
    "feature": "보습, 아미노산",
    "desc": "가장 작은 아미노산으로 모발에 흡수가 잘 되고 수분을 유지시킨다. 아미노산 복합 성분에 포함되어 사용된다.",
    "source": "system"
  },
  {
    "ko": "알라닌",
    ...
    "strength": "약",
    "feature": "보습, 큐티클 보호",
    "desc": "비필수 아미노산으로 모발 표면의 자연보습인자(NMF) 구성요소다. 수분을 유지하고 큐티클을 보호하는 데 도움을 준다.",
    "source": "system"
  },
  {
    "ko": "아스파르트산",
    ...
    "strength": "약",
    "feature": "킬레이트, 보호",
    "desc": "산성 아미노산으로 미네랄 이온과 결합하는 킬레이트 역할을 한다. 수돗물 미네랄로 인한 모발 손상을 줄이는 데 도움을 준다.",
    "source": "system"
  },
  {
    "ko": "소듐 라우릴 설포아세테이트",
    "en": "Sodium Lauryl Sulfoacetate",
    "cat": "세정",
    "mid": "계면활성제",
    "role": "저자극 세정 / 풍부한 거품",
    "strength": "약",
    "feature": "저자극, 풍부한 거품",
    "desc": "코코넛 유래 저자극 계면활성제로 SLS와 이름이 비슷하지만 전혀 다른 성분이다. 풍부한 거품과 낮은 자극이 특징이며 고체 샴푸 바에 많이 사용된다.",
    "source": "system"
  },
  {
    "ko": "아세틸 테트라펩타이드-3",
    "en": "Acetyl Tetrapeptide-3",
    "cat": "두피",
    "mid": "탈모케어",
    "role": "모낭 앵커링 강화 / 탈모 방지",
    "strength": "중",
    "feature": "모근 강화, 탈모 방지",
    "desc": "카피실(Capixyl)의 핵심 성분으로 모낭의 앵커링 단백질을 강화해 모발이 쉽게 빠지는 것을 방지한다. 레드 클로버 추출물과 함께 사용된다.",
    "source": "system"
  },
  {
    "ko": "레드 클로버 추출물",
    "en": "Trifolium Pratense Flower Extract",
    "cat": "두피",
    "mid": "탈모케어",
    "role": "DHT 억제 / 모낭 보호",
    "strength": "약",
    "feature": "DHT 억제, 모낭 보호",
    "desc": "레드 클로버에서 추출한 이소플라본이 DHT 생성을 억제하고 모낭을 보호한다. 아세틸 테트라펩타이드-3과 함께 카피실 복합 성분으로 사용된다.",
    "source": "system"
  },
  {
    "ko": "비오틴아미드 디프로필디아민 HCl",
    "en": "Biotinoyl Tripeptide-1",
    "cat": "두피",
    "mid": "탈모케어",
    "role": "모근 강화 / 모발 밀도 증가",
    "strength": "약",
    "feature": "모근 강화, 밀도 증가",
    "desc": "프로캐필(Procapil)의 구성 성분으로 비타민 H(비오틴)와 펩타이드가 결합된 형태다. 모근을 강화하고 모발 밀도를 높이는 데 도움을 준다.",
    "source": "system"
  },
  {
    "ko": "소 포르피렐 트라이펩타이드-1",
    "en": "Saw Palmetto Extract",
    "cat": "두피",
    "mid": "탈모케어",
    "role": "DHT 억제 / 탈모 예방",
    "strength": "중",
    "feature": "DHT 억제, 탈모 예방",
    "desc": "쏘팔메토 열매에서 추출한 성분으로 5-알파 환원효소를 억제하여 DHT 생성을 줄인다. 남성형 탈모 예방 제품에 많이 사용된다.",
    "source": "system"
  },
  {
    "ko": "피나스테라이드",
    ...
    "role": "DHT 억제 / 탈모 치료",
    "strength": "강",
    "feature": "DHT 억제, 탈모 치료",
    "desc": "의약품 성분으로 5-알파 환원효소를 강하게 억제해 DHT 생성을 차단한다. 남성형 탈모 치료에 사용되며 반드시 전문가 처방이 필요하다.",
    "source": "system"
  },
  {
    "ko": "하이드로코티사이드 아세테이트",
    "en": "Hydrocortisone Acetate",
    "cat": "두피",
    "mid": "두피케어",
    "role": "두피 염증 억제 / 가려움 완화",
    "strength": "강",
    "feature": "항염, 가려움 억제",
    "desc": "스테로이드 계열 항염증제로 심한 두피 가려움과 염증을 빠르게 진정시킨다. 의약품 성분으로 장기 사용 시 부작용이 있어 전문가 지도하에 사용해야 한다.",
    "source": "system"
  },
  {
    "ko": "황",
    ...
    "strength": "중",
    "feature": "각질 제거, 항균",
    "desc": "오랜 역사를 가진 두피 케어 성분으로 각질을 부드럽게 녹이고 항균 효과가 있다. 지루성 두피염과 비듬 치료에 사용되며 특유의 냄새가 있다.",
    "source": "system"
  },
  {
    "ko": "아연",
    ...
    "strength": "약",
    "feature": "피지 조절, 성장 지원",
    "desc": "미네랄 성분으로 두피의 피지 분비를 조절하고 모발 케라틴 합성에 관여한다. 부족 시 탈모와 두피 문제가 발생할 수 있다.",
    "source": "system"
  },
  {
    "ko": "철",
    ...
    "strength": "약",
    "feature": "산소 공급, 성장",
    "desc": "혈액 내 산소 운반에 필수적인 미네랄로 모낭에 산소를 공급해 모발 성장을 돕는다. 철분 부족은 탈모의 주요 원인 중 하나다.",
    "source": "system"
  },
  {
    "ko": "규소",
    ...
    "strength": "약",
    "feature": "탄력, 강도",
    "desc": "미네랄 성분으로 모발의 콜라겐과 케라틴 생성에 보조적으로 관여한다. 모발의 탄력과 강도를 유지하는 데 도움을 준다.",
    "source": "system"
  },
  {
    "ko": "마린 콜라겐",
    ...
    "strength": "중",
    "feature": "탄력, 보습",
    "desc": "어류에서 추출한 콜라겐으로 분자가 작아 모발에 잘 흡수된다. 모발에 탄력과 수분을 동시에 공급하며 보통 콜라겐보다 흡수율이 높다.",
    "source": "system"
  },
  {
    "ko": "실크 아미노산",
    ...
    "strength": "약",
    "feature": "보습, 광택",
    "desc": "실크를 아미노산 수준까지 분해한 초미세 성분으로 모발 깊이 침투해 보습하고 비단결 같은 광택을 만든다. 가수분해 실크보다 분자가 더 작다.",
    "source": "system"
  },
  {
    "ko": "무수 치오황산 나트륨",
    ...
    "cat": "펌제",
    "mid": "중화제",
    "role": "잔류 산화제 중화 / 시술 후 안정",
    "strength": "약",
    "feature": "중화, 안정화",
    "desc": "탈색이나 펌 시술 후 모발에 남아있는 잔류 산화제를 중화시켜 추가 손상을 막는다. 시술 후처리 단계에서 사용된다.",
    "source": "system"
  },
  {
    "ko": "라우릴 PEG-9 폴리다이메틸실록시에틸 다이메티콘",
    "en": "Lauryl PEG-9 Polydimethylsiloxyethyl Dimethicone",
    "cat": "크리닉",
    "mid": "유화",
    "role": "실리콘 유화 / 크림 질감",
    "strength": "약",
    "feature": "실리콘 유화, 크림감",
    "desc": "실리콘 유화제로 다이메티콘 등 실리콘 오일을 수성 제형에 안정적으로 섞어준다. 실리콘 기반 크림과 세럼 제형에 필수적이다.",
    "source": "system"
  },
  {
    "ko": "피토케라틴",
    ...
    "cat": "크리닉",
    "mid": "단백질",
    "role": "식물 유래 단백질 보강 / 손상 회복",
    "strength": "중",
    "feature": "식물 유래, 손상 회복",
    "desc": "밀, 대두, 옥수수 등 식물 단백질을 모발 케라틴과 유사한 아미노산 조성으로 배합한 복합 성분이다. 비건 케라틴 트리트먼트에 사용된다.",
    "source": "system"
  },
  {
    "ko": "모노에탄올아민",
    ...
    "strength": "중",
    "feature": "저취 알칼리, 큐티클 개방",
    "desc": "에탄올아민의 다른 표기명으로 암모니아를 대체하는 알칼리 성분이다. 냄새가 적지만 모발에 잔류하여 지속적 자극을 줄 수 있으므로 충분한 헹굼이 필요하다.",
    "source": "system"
  },
  {
    "ko": "소듐 하이드로설파이트",
    ...
    "strength": "중",
    "feature": "탈염, 색소 환원",
    "desc": "산화 염료를 환원시켜 탈색 없이 염색을 제거하는 리무버 성분이다. 모발의 멜라닌에는 영향을 주지 않고 인공 색소만 분해한다.",
    "source": "system"
  }
];
