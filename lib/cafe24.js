...
// 카페24 API 통신 헬퍼
// v24 재설계:
//   - 기존 Admin OAuth 부분 유지 (앱 설치용) → cafe24api.com 도메인
//   - Customer OAuth 함수 신규 추가 (사용자 로그인용) → cafe24.com 도메인
...
// ============================================================
// Customer OAuth (쇼핑몰 회원 인증용) - 신규 추가
// ⚠️ Admin OAuth와 달리 cafe24.com 도메인 사용
// ⚠️ scope는 mall.read_customer_identifier 사용
// ============================================================

/**
 * Customer 로그인 시작 URL 생성
 * 사용자를 이 URL로 보내면 자사몰 회원 로그인 화면 뜸
